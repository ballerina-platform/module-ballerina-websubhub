...
- [Introduce a mechanism to notify subscribers when there is an error invoking the `onSubscriptionIntentVerified` method on `hub`](https://github.com/ballerina-platform/ballerina-library/issues/8681)
